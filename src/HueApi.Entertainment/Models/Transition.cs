...
namespace HueApi.Entertainment.Models
{
  ...
  public class Transition
  {
    ...
    public void UpdateCurrentState()
    {
      ...
      var rgbProgress = sw.Elapsed.TotalMilliseconds / _rgbTimeSpan.TotalMilliseconds;
      var briProgress = sw.Elapsed.TotalMilliseconds / _briTimeSpan.TotalMilliseconds;
      ...
      if (_deltaR.HasValue && _deltaG.HasValue && _deltaB.HasValue && !IsRgbFinished)
      {
