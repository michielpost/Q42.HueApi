...
namespace HueApi.Tests
{
  ...
  public class SpeakerTests
  {
    ...
    {
      var result = await localHueClient.GetSpeakersAsync();
    ...
    {
      var all = await localHueClient.GetSpeakersAsync();
      var id = all.Data.First().Id;

      var result = await localHueClient.GetSpeakerAsync(id);
    ...
    public async Task PutById()
    {
      ...
      var result = await localHueClient.UpdateSpeakerAsync(id, req);
