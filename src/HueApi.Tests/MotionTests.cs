...
namespace HueApi.Tests
{
  ...
  public class MotionTests
  {
    ...
    {
      var result = await localHueClient.Motion.GetAllAsync();
    ...
    {
      var all = await localHueClient.Motion.GetAllAsync();
      var id = all.Data.First().Id;

      var result = await localHueClient.Motion.GetByIdAsync(id);
    ...
    public async Task PutById()
    {
      ...
      var result = await localHueClient.Motion.UpdateAsync(id, req);
