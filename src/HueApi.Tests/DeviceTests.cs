...
namespace HueApi.Tests
{
  ...
  public class DeviceTests
  {
    ...
    {
      var result = await localHueClient.Device.GetAllAsync();
    ...
    {
      var all = await localHueClient.Device.GetAllAsync();
      var id = all.Data.First().Id;

      var result = await localHueClient.Device.GetByIdAsync(id);
    ...
    public async Task PutById()
    {
      ...
      var result = await localHueClient.Device.UpdateAsync(id, req);
